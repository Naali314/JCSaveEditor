...
public class JCSaveDataHelper
{
    ...
    private void loadMinionLists()
    {
        for (int slot = 0; slot < 15; slot++)
        {
            ...
            minion.setDmFire(this.saveData.getMinionDMFire(slot));
            minion.setDmAir(this.saveData.getMinionDMAir(slot));
            minion.setDmEarth(this.saveData.getMinionDMEarth(slot));
            minion.setDmWater(this.saveData.getMinionDMWater(slot));
            minion.setDmPoison(this.saveData.getMinionDMPoison(slot));
            minion.setDmSleep(this.saveData.getMinionDMSleep(slot));
            minion.setDmFleshToStone(this.saveData.getMinionDMFleshToStone(slot));
            minion.setDmDeath(this.saveData.getMinionDMDeath(slot));
            minion.setDmAbsorption(this.saveData.getMinionDMAbsorption(slot));
            minion.setDmHealing(this.saveData.getMinionDMHealing(slot));
            minion.setDmBasicAttack(this.saveData.getMinionDMBasicAttack(slot));
    ...
    public void setPartyMinion(int partySlot, Optional<Minion> minionOptional)
    {
        if (minionOptional.isPresent())
        {
            ...
            this.saveData.setMinionDMFire(partySlot, minion.getDmFire());
            this.saveData.setMinionDMAir(partySlot, minion.getDmAir());
            this.saveData.setMinionDMEarth(partySlot, minion.getDmEarth());
            this.saveData.setMinionDMWater(partySlot, minion.getDmWater());
            this.saveData.setMinionDMPoison(partySlot, minion.getDmPoison());
            this.saveData.setMinionDMSleep(partySlot, minion.getDmSleep());
            this.saveData.setMinionDMFleshToStone(partySlot, minion.getDmFleshToStone());
            this.saveData.setMinionDMDeath(partySlot, minion.getDmDeath());
            this.saveData.setMinionDMAbsorption(partySlot, minion.getDmAbsorption());
            this.saveData.setMinionDMHealing(partySlot, minion.getDmHealing());
            this.saveData.setMinionDMBasicAttack(partySlot, minion.getDmBasicAttack());
